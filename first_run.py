...
#this will be located in a separate file in the docker version
#note that the sqlitedict datatype does not get updated implicitly if a derivative variable is changed in memory
#so always make explicit assignments
