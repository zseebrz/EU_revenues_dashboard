...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 16 10:44:39 2021

@author: zseebrz
"""


#forked from the official pm4py repo to return the digraph object instead of the rendered bitmap temp file
'''
...
def apply(heu_net: HeuristicsNet, parameters: Optional[Dict[Union[str, Parameters], Any]] = None) -> str:
    ...
    #return pydotplus.graphviz.graph_from_dot_data(graph)
    return graph